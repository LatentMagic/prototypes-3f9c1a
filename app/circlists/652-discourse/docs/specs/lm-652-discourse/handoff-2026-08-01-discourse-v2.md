...
1. Ideated every note individually and wrote it up —
   `docs/specs/lm-652-discourse/ideation-2026-07-31-discourse-v2.md`. Part 1 is note by
...
- `docs/specs/lm-652-discourse/ideation-2026-07-31-discourse-v2.md` — **read first.**
...
- `docs/specs/lm-652-discourse/pg-d2-record.jsx` — `D2Row` now gates the `to {name}`
...
- `docs/specs/lm-652-discourse/README.md:1` — supersede banner pointing at v2.
...
- `discourse-playground-v2.html` — entry at the project root, so `app/*` and
  `tokens.css` resolve.
- `docs/specs/lm-652-discourse/pg-d2-data.jsx` — the spine as Auto lever answers
...
- `docs/specs/lm-652-discourse/pg-d2-parts.jsx` — the sheet (bottom sheet narrow /
...
- `docs/specs/lm-652-discourse/pg-d2-card.jsx` — the shipped enriched card copied, plus
  the preface hanging off the attribution and the micro dot on the door.
- `docs/specs/lm-652-discourse/pg-d2-record.jsx` — the record (door and moment are the
  same surface) and the Add sheet.
- `docs/specs/lm-652-discourse/pg-d2-table.jsx` — the table as a page, tabs, empty states.
- `docs/specs/lm-652-discourse/pg-d2-app.jsx` — the four-pane rail, the app surface, the
  loop driver.
- `docs/specs/lm-652-discourse/ideation-2026-07-31-discourse-v2.md` — the ideation record.
- `docs/specs/lm-652-discourse/README.md` — v1 index, now carrying the supersede banner.
