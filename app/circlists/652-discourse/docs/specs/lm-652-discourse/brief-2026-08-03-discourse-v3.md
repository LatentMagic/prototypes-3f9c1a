...
4. `docs/specs/lm-652-discourse/README.md` — the design question and its history.
5. `docs/specs/lm-652-discourse/ideation-2026-07-31-discourse-v2.md` — the settled
   spine and the K0–K6 continuation directions.
6. `docs/specs/lm-652-discourse/handoff-2026-08-01-discourse-v2.md` — state of the v2
   build, including the 2026-08-01 refinement pass at the top of Recent
   changes.
7. `docs/specs/lm-652-discourse/handoff-2026-07-27-discourse-playground.md` — the v1
