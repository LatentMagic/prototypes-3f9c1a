...
- Playground mechanics (posture, config levers, wiring, export) — in the prototypes repo, the `circlists-prototypes` skill (`.claude/skills/circlists-prototypes/SKILL.md` at the repo root). Placement and the launcher stay in this file.
...
### Building here
- `circlists-prototypes` (repo root `.claude/skills/`) — before building any rig, option study, whiteboard or comparison the user will play with.
