...
const CandRoom = React.forwardRef(({ value, onChange, max, placeholder, maxPx }, ref) => {
  ...
  // Item 3 (ratified 2026-08-19): this box warns like every other box that can
  // reach 500 — the count of characters remaining, drawn only inside the last 60,
  // in the same treatment and the same position the reference boxes use (right
  // edge, beneath the words). The link slot carries no cap and no count.
