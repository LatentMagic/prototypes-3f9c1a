...
// `caption`: an optional quiet line under the group's OWN label, not a new
// signal bolted onto the control — one line of type, never a badge or an
// accent. No group passes it today (the Saved row carries no sub-line).
...
// Joe's fix, 2026-09: bare is now sentence
...
// `saved`/`onSaved`: a third, independent
