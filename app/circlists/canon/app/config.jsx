...
function buildScenarios(api) {
  ...
  const GROUPS = [
    ...
    { title: 'Members & funding', items: [
      { k: 'Members \u2014 champion (you)', go: () => stageFunding(null) },
      { k: 'Members \u2014 non-champion', go: stageNonChampion },
      { k: 'Members \u2014 circle full', go: goFullSpaceManage },
      { k: 'Funding \u2014 ending on a date', go: () => stageFunding({ state: 'ending', endsAt: Date.now() + 18 * DAY }) },
      { k: 'Funding \u2014 payment retrying', go: () => stageFunding({ state: 'retrying', retryWindow: '14 days' }) },
      { k: 'Circle with no champion', go: stageNoChampion },
    ...
    { title: 'Dormant circle', items: [
      { k: 'Dormant circle', go: () => stageDormant({ champion: 'Priya N.', championEmail: 'priya.n@example.com', dormancy: 'terminal' }) },
      { k: 'Suspended by us', go: () => stageDormant({ champion: 'Priya N.', championEmail: 'priya.n@example.com', dormancy: 'suspended' }) },
    ] },
