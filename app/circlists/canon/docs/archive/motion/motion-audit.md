...
**Note — this verdict was reversed after discussion with the user, then implemented. Reasoning below is the final call; see `handoff-brand-motion.md` for what shipped.**
