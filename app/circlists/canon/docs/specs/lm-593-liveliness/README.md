...
- `../../../archive/liveliness/` — the playground (`liveliness-playground.html` +
  `pg-live-{data,parts,app}.jsx`) that produced the grammar. **Archived and historical.** The app is
  now the spec; several options visible in the playground were rejected and are listed in the
  handoff.
