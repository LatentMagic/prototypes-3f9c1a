...
1. `docs/specs/discourse/PROMPT.md` — **the original brief. It is still the
   brief.** Everything in it that says "settled" is still settled.
2. `docs/specs/discourse/postmortem-2026-08-03-discourse.md` — how v2 and v3
   failed. The five failures and the rules that follow are binding on you.
3. `docs/specs/discourse/review-2026-07-30-v1-notes.md` — both reviewers on v1,
   verbatim. **These are steering on the options, not a verdict.**
4. `docs/specs/discourse/README.md` — the v1 option table. (Its supersede banner
   points at v2 and is now wrong; fix it as part of this work.)
5. `docs/specs/discourse/handoff-2026-07-27_discourse-playground.md` — how v1 was
...
6. `CLAUDE.md`, `PLAYGROUND.md`, `GOTCHA.md`, `wiki/circlists-copy-voice.md`,
   ...
   tokens. All binding.
7. `docs/specs/discourse/ideation-2026-07-31-discourse-v2.md` — **read last, and
...
1. **Ideate first, in a document** — `docs/specs/discourse/ideation-2026-08-03-discourse-v4.md`.
...
3. **Build**, new files, kebab-case: `discourse-playground-v4.html` +
   `docs/specs/discourse/pg-d4-*.jsx`. Fork; never mutate v1, v2 or v3 files.
...
- `docs/specs/discourse/ideation-2026-08-03-discourse-v4.md` — the ideation,
...
- `docs/specs/discourse/README.md` — supersede banner corrected to point here.
