...
Built from `docs/specs/discourse/brief-2026-08-03-discourse-v3.md`. v1 and v2 are
...
- `docs/specs/discourse/pg-d3-data.jsx` — the twelve versions and their seeding.
- `docs/specs/discourse/pg-d3-app.jsx` — the list, the levers behind it, the app
  surface.
