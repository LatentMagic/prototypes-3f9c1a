// ============================================================================
// COPY — app/swell-reactions.jsx, verbatim, with a WIDER window export only.
// ----------------------------------------------------------------------------
// Source: app/swell-reactions.jsx. Nothing in the body is edited, tuned or
// "improved" — a copy that diverges stops being evidence (PLAYGROUND.md).
// Why the copy exists: the playground's reaction+reflection flow has to compose
// the Swell's INTERNALS (SwellPad, SwellPalette, SwellGlyphRadios, SwellReview,
// SwellScatter, the depth vocabulary and geometry), and the shipped module keeps
// them in Babel scope, exporting only SwellDoor / SwellReviewModal /
// SwellReactionFlow. Exporting them from app/ is the real fix on the next ask —
// raised, not taken, because app/ is not touched to serve an exploration.
// This file REPLACES app/swell-reactions.jsx on the playground page; the three
// shipped exports below are byte-identical to the product's.
// ============================================================================
// ============================================================================
...
Object.assign(window, {
  RX_GLYPHS, SwellDoor, SwellReviewModal, SwellReactionFlow,
  // — internals, exported for the playground only —
  SwellPad, SwellPalette, SwellGlyphRadios, SwellScatter, SwellReview,
  DEPTH_WORDS, GLYPH_NAMES, depthWord, glyphName, levelFromIntensity, intensityFromLevel,
  glyphAngle, glyphIndexOf, SWELL_MAX, rxIsSkip, rxLabel, rxAriaLabel, rxOthers, rxMine, iv,
  useSheetMount, lockScroll, trapTab, CloseX, ReadRing,
});
