...
// funding) lands here instead, and the member is told to finish on the web. No
// checkout, no price, no provider surface is reachable.
//
...
// primary action. It is a fourth calm full page, not a treatment of its own.
// Voice: direct, present-tense, non-blaming, no urgency — the same calm floor as
// every other surface. main.jsx guards the routes and renders this in their
...
const WebHandoff = ({ context = 'new', spaceName, onExit }) => {
  ...
  return (
    <CalmPage eyebrow={c.eyebrow} title={c.title(spaceName)} body={c.body(spaceName)}
      actionLabel="Back to your circles" onAction={onExit}>
      <div style={{
