...
const LP_ICONS = {
  ...
  // Search (feed-enhancement candidate build). No prior magnifier in this set —
...
// destructive-secondary: the house SECONDARY box with the danger colour in the
// label. Not a new component and not a peer of the primary — fill outranks
// outline on its own, so the ranking survives while the control keeps a real
// box. A box matters: an unboxed control in a stack has no honest spacing (its
// hit area is empty space until hover paints it). Used for Leave beside Fund.
const Button = React.forwardRef((props, ref) => {
  ...
  const variants = {
    ...
    'destructive-secondary': { background: 'var(--color-surface)', color: 'var(--color-destructive)', border: '1px solid var(--color-border-1)', fontWeight: 500 },
