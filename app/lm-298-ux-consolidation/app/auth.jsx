...
const AuthFrame = ({ title, subtitle, children, footer, onBack }) => (
  <div style={{
    ...
    <div style={{ width: '100%', maxWidth: 400, display: 'flex', justifyContent: onBack ? 'space-between' : 'center', alignItems: 'center', marginTop: 'min(8vh, 64px)', marginBottom: 32 }}>
      {onBack && (
...
// context: 'signup' | 'device' | 'recovery'. initialError lets the journey
