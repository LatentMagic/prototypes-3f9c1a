...
Each prototype is deep-linkable at `#<slug>` — e.g. `…/prototypes-3f9c1a/#next` opens straight to that tab, and the URL tracks the active tab so it's always ready to copy and share.
